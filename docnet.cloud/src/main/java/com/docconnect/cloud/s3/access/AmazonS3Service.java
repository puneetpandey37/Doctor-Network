package com.docconnect.cloud.s3.access;
...
import com.docconnect.cloud.exception.S3AccessException;
import com.docconnect.cloud.s3.model.S3MetaData;
...
public class AmazonS3Service {
	...
	public static void main(String[] args) throws S3AccessException {
		...
		S3Options s3Options = new S3Options("bucket", "accessid", "secretKey");
		AmazonS3Service amazonS3Service = new AmazonS3Service(
				"s3-ap-southeast-1.amazonaws.com", s3Options);
		amazonS3Service.createBucket("test-elyxbucket",
